...
namespace web_ese.Models
{
	public class CommFunction : DatabaseConnection
	{
		...
		{
			string SELECT_LANG = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
			string returnFieldName = "";

			if (type == "NATIONNAME")
			{
				switch (SELECT_LANG)    //lan <== 다국어 지원 관련 언어선택 부분이므로 일단 신경쓰지 말고 진행 할것  그냥 돌리면 알아서 NATIONNAME_ko_KR 을 설정함
				{
					case "zh-CN":		returnFieldName = "NATIONNAME_zh_CN";	break;
					case "en-US":	returnFieldName = "NATIONNAME";			break;
					case "ko-KR":	returnFieldName = "NATIONNAME_ko_KR";	break;
					default:		returnFieldName = "NATIONNAME_ko_KR";	break;
				}
			}
			...
			if (type == "CATENNAME")
			{
				switch (SELECT_LANG)    //lan <== 다국어 지원 관련 언어선택 부분이므로 일단 신경쓰지 말고 진행 할것  그냥 돌리면 알아서 NATIONNAME_ko_KR 을 설정함
				{
					case "zh-CN":		returnFieldName = "CATE_NAME_CN";	break;
					case "en-US":		returnFieldName = "CATE_NAME_EN";	break;
					case "ko-KR":	returnFieldName = "CATE_NAME_KR";	break;
					default:		returnFieldName = "CATE_NAME_KR";	break;
				}
			}
			...
			if (type == "TITLE")
			{
				switch (SELECT_LANG)    //lan <== 다국어 지원 관련 언어선택 부분이므로 일단 신경쓰지 말고 진행 할것  그냥 돌리면 알아서 NATIONNAME_ko_KR 을 설정함
				{
					case "zh-CN":		returnFieldName = "TITLE_CN";	break;
					case "en-US":		returnFieldName = "TITLE_EN";	break;
					case "ko-KR":	returnFieldName = "TITLE_KR";	break;
					default:		returnFieldName = "TITLE_KR";	break;
				}
			}
