    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(AccountLoginModel viewModel)
		{
			...
			if (viewModel.RememberMe)
			{
				...
				HttpCookie CHK_LOGIN_REMEMBER = new HttpCookie("CHK_LOGIN_REMEMBER");
				CHK_LOGIN_REMEMBER.Values["MANAGE_NO"] = model.SEQNO.ToString();
				CHK_LOGIN_REMEMBER.Values["MANAGE_GRADE"] = model.GROUP_ID.ToString();
				CHK_LOGIN_REMEMBER.Values["CURRENT_LOGIN_EMAIL"] = model.EMAIL.ToString();
				CHK_LOGIN_REMEMBER.Values["EST_CODE"] = model.EST_CODE.ToString();
				CHK_LOGIN_REMEMBER.Values["ESE_CODE"] = model.ESE_CODE.ToString();
				CHK_LOGIN_REMEMBER.Values["STATUS"] = model.STATUS.ToString();
				CHK_LOGIN_REMEMBER.Expires = DateTime.Now.AddDays(365);
				Response.Cookies.Add(CHK_LOGIN_REMEMBER);
			}
			else
			{
